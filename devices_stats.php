...
<body id="page-top">
                    ...
                    <div class="">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Nombre d'utilisateurs par dispositif</h6>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="usersByDeviceLegende" class="mt-4 text-center small">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="js/devices_stats.js"></script>
